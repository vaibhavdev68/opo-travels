...
const HeaderBanner = () => {
  return (
    <div className="bg-gradient-to-r mt-12 from-teal-600 to-teal-700 rounded-3xl shadow-2xl overflow-hidden transform hover:scale-[1.02] transition-all duration-300 hover:shadow-2xl">
      <div className="flex flex-col md:flex-row items-center justify-between text-white p-8 md:p-12">
        <div className="text-center md:text-left">
          ...
          <p className="text-lg text-teal-200 mt-4 font-medium">
