...
export default function ChatBot() {
  ...
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content:
        "👋 Hi! I'm your AI travel assistant from OPO Travels! I can help you with:\n• Destination recommendations\n• Travel planning\n• Booking information\n• Package details\n\nWhat would you like to know? 🌍",
    },
  ]);
  ...
  const defaultMessage = encodeURIComponent(
    "Hello! I want to chat about travel packages and destinations."
  );
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        {
          role: "assistant",
          content:
            "❌ I'm having trouble connecting right now. Please try our WhatsApp support for immediate assistance, or try again later.",
        },
      ]);
    } finally {
      setLoading(false);
      ...
      {chatOpen && (
        <div
          className="
            ...
            xs:w-[90vw] xs:h-[80vh] xs:bottom-4 xs:right-1/2 xs:translate-x-1/2
            bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden 
            z-50 border-t-4 border-purple-500
          "
        >
          {/* Header */}
          ...
          {/* Chat Messages */}
          <div className="flex-1 p-4 overflow-y-auto space-y-4 bg-gray-50 text-sm sm:text-[13px]">
            {messages.map((msg, i) => (
              <div
                key={i}
                className={`flex ${
