      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex justify-center lg:justify-start gap-4 -mt-8 md:-mt-10 lg:ml-20"> 
              <a
                ...
                className={`
                  ...
                  hover:bg-teal-600 hover:-translate-y-1 hover:scale-110
                  transition-transform duration-300 shadow-lg hover:shadow-teal-500/25
                `}
              >
          ...
          <div className="w-full lg:flex-1">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
              ...
              <div className="text-center md:text-left">
                <h3 className="text-xl md:text-2xl font-bold mb-4 md:mb-6 text-white bg-gradient-to-r from-teal-400 to-teal-600 bg-clip-text">
                  Company
                </h3>
        ...
        <div className="border-t border-gray-800 mt-8 md:mt-12 pt-6 md:pt-8 text-center">
          <p className="text-sm md:text-base text-gray-400">
            ...
            <span className="text-teal-400 ml-1">Crafting Unforgettable Journeys</span>
          </p>
        </div>
      </div>
